...
class SpectralMixture(Kernel):
    ...
    def K(self, X1, X2=None):
        ...
        print(f"tf.expand_dims(r,-1) = {tf.expand_dims(r,-1)}")
        print(f"tf.tile(tf.expand_dims(r,-1),(1,1,1,self.num_mixtures))={tf.tile(tf.expand_dims(r,-1),(1,1,1,self.num_mixtures))}")
